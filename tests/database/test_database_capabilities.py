...
def test_postgresql_normalizes_sqlite_autoincrement():
    sql = PostgreSQLDatabase._normalize_sql(
        """
...
def test_sqlite_execute_transaction_uses_existing_connection():
    calls = []
...
def test_postgresql_execute_transaction_normalizes_sql():
    calls = []
